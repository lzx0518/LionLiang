...
(function (root) {
  ...
  var TASKS = [
    ...
    /* ------------------------------------------------------------------ */
    {
      ...
      intro: '气垫导轨可以认为没有摩擦，绳与滑轮的质量不计。使小车产生加速度的是绳的拉力 F（拉力由砝码通过滑轮提供），所以 a = F / m。注意 F 并不等于砝码重力：砝码自己也在加速，绳的拉力略小于 m_h·g，本仿真按 a = m_h·g/(m + m_h) 如实计算。',
      principle: ['a = F / m（F 为绳的拉力）', '控制变量法：先固定 m 找 a–F，再固定 F 找 a–1/m'],
      steps: [
        {
